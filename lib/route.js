...
Router.prototype.resource = function(route, resource) {
  ...
  router.get(route, function(req, res) {resource.list(req, res, db)});
  router.post(route, function(req, res) {resource.create(req, res, db)});
  router.get(route + '/:id', function(req, res) {resource.read(req, res, db)});
  router.post(route + '/:id', function(req, res) {resource.update(req, res, db)});
  router.get(route + '/:id/destroy', function(req, res) {resource.destroy(req, res, db)});
}
